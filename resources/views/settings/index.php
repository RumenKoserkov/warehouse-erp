    ...
    <div class="card-body">
        <form action="/settings/update" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <div class="form-check">
                        ...
                        <label
                            for="sales_prices_include_vat"
                            class="form-check-label">
                            Selling prices include VAT
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-check">
                        <input
                            type="checkbox"
                            id="purchase_prices_include_vat"
                        ...
                        <label
                            for="purchase_prices_include_vat"
                            class="form-check-label">
                            Purchase prices include VAT
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="alert alert-light border">
                VAT registration requires a VAT number in
